...
function atualizarTabela() {
    fetch('https://stockmaster-b4801-default-rtdb.firebaseio.com/produtos.json')
        .then(response => {
            if (!response.ok) {
...
function buscarProximoID() {
    return fetch('https://stockmaster-b4801-default-rtdb.firebaseio.com/produtos.json')
...
function excluirProduto(id) {
    ...
    fetch(`https://stockmaster-b4801-default-rtdb.firebaseio.com/produtos/${id}.json`, {
        method: 'DELETE'
    })
        .then(response => {
            if (!response.ok) {
